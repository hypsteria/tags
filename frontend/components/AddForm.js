...
class AddForm extends React.Component {
	...
	constructor (props) {
		super(props);
		this.state = { washingAddons: false };
		this.handleChange = this.handleChange.bind(this);
	};

	handleChange(e) {
		if (e.currentTarget.id === 'wh-washing') {
			this.setState({washingAddons: true});
		} else {
			this.setState({washingAddons: false});
		}
	};
		...
		return (
			<div>
				...
				>
					...
					<div style={ (this.state.washingAddons) ? {} : styleHidden }>
						<FormGroup className="lined">
